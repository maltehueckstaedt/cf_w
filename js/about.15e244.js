...
$(function(){
un13=document.querySelectorAll('.un13');
if(un13.length){
un13=new Plyr('.un13 audio',{'iconUrl':'css/plyr.svg',controls:['play','progress','current-time','mute','volume'],storage:{enabled:false}});
un13.volume=0.5;
