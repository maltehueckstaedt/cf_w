...
$(function(){
un9=document.querySelectorAll('.un9');
if(un9.length){
un9=new Plyr('.un9 audio',{'iconUrl':'css/plyr.svg',controls:['play'],storage:{enabled:false}});
un9.volume=0.5;
un9.on('play',function(){plst('un9',function(){un9.pause();})});
un9.on('pause ended',function(){plrm('un9')});
}
