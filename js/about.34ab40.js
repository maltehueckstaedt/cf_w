...
un5=document.querySelectorAll('.un5');
if(un5.length){
un5=new Plyr('.un5 audio',{'iconUrl':'css/plyr.svg',controls:['play'],storage:{enabled:false}});
un5.volume=0.5;
un5.on('play',function(){plst('un5',function(){un5.pause();})});
un5.on('pause ended',function(){plrm('un5')});
}
