...
$(function(){
r=function(){if(thresholdPassed()){dpi=window.devicePixelRatio;if($(window).width()>=1200){var e=document.querySelector('.un1');e.setAttribute('src',(dpi>1)?'images/elemente-858.jpg':'images/elemente-429.jpg');}else if($(window).width()>=960){var e=document.querySelector('.un1');e.setAttribute('src',(dpi>1)?'images/elemente-686.jpg':'images/elemente-343.jpg');}else{var e=document.querySelector('.un1');e.setAttribute('src',(dpi>1)?'images/elemente-548.jpg':'images/elemente-274.jpg');}}};
