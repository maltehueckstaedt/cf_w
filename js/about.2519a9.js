...
un16=document.querySelectorAll('.un16');
if(un16.length){
un16=new Plyr('.un16 audio',{'iconUrl':'css/plyr.svg',controls:['play'],storage:{enabled:false}});
un16.volume=0.5;
un16.on('play',function(){plst('un16',function(){un16.pause();})});
un16.on('pause ended',function(){plrm('un16')});
}
initMenu($('#m2')[0]);
