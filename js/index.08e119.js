...
$(function(){
r=function(){if(thresholdPassed()){dpi=window.devicePixelRatio;if($(window).width()>=1200){var e=document.querySelector('.un1');e.setAttribute('src','images/untitled_mobile-463.jpg');
var e=document.querySelector('.un2');e.setAttribute('src',(dpi>1)?'images/elemente-858.jpg':'images/elemente-429.jpg');}else if($(window).width()>=960){var e=document.querySelector('.un1');e.setAttribute('src','images/untitled_mobile-370.jpg');
var e=document.querySelector('.un2');e.setAttribute('src',(dpi>1)?'images/elemente-686.jpg':'images/elemente-343.jpg');}else if($(window).width()>=768){var e=document.querySelector('.un1');e.setAttribute('src','images/untitled_mobile-296.jpg');
var e=document.querySelector('.un2');e.setAttribute('src',(dpi>1)?'images/elemente-548.jpg':'images/elemente-274.jpg');}else{var e=document.querySelector('.un1');e.setAttribute('src',(dpi>1)?'images/untitled_mobile-246.jpg':'images/untitled_mobile-123.jpg');}}};
...
un3=document.querySelectorAll('.un3');
if(un3.length){
un3=new Plyr('.un3 audio',{'iconUrl':'css/plyr.svg',controls:['play'],storage:{enabled:false}});
un3.volume=0.5;
un3.on('play',function(){plst('un3',function(){un3.pause();})});
un3.on('pause ended',function(){plrm('un3')});
}
